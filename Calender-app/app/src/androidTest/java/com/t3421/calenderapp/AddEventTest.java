...
public class AddEventTest {
    ...
    public void getDateString() throws Exception {
        ...
        assertEquals("31 December 2017" , tester.getDateString(2017,11,31));
    ...
    public void getTimeString() throws Exception {
        assertEquals("12:00 AM" , tester.getTimeString(0,0));
    ...
    public void getSpinnerPosition() throws Exception {
        ...
        assertEquals( 0 , tester.getSpinnerPosition(null));
    }

    @Test
    public void setOccurrenceId() throws Exception {
